...
let rowss = new MessageActionRow()
                ...
                if (serverQueue) {
                    ...
                    if (playlist) return undefined;
                        ...
                        const sembed = new MessageEmbed()
                            .setColor("GREEN")
                            .setTitle("<a:SahanMusic:903182448152678481> Added To Queue", message.author.displayAvatarURL())
                            .setThumbnail(song.thumbnail)
                            .setTimestamp()
                            .setImage("https://i.imgur.com/x0f7AZM.gif")
                            .setDescription(`**<a:SahanMusic:903182448152678481> Title:** [${song.title}](${song.url}) \n\n **<a:SahanMusic:903182448152678481>Song Duration:** ${np} minutes \n\n **Status:** Pending`)
  ...
  const serverQueue = ops.queue.get(message.guild.id);
                ...
                const embed = new MessageEmbed()
                    .setColor("GREEN")
                    .setTitle('<a:SahanMusic:903182448152678481> Started Playing')
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setImage("https://i.imgur.com/x0f7AZM.gif")
                    .setDescription(`**<a:SahanMusic:903182448152678481>** [${song.title}](${song.url}) \n\n **<a:SahanMusic:903182448152678481>Song Duration** ${np} minutes \n\n **Status:** **Playing** \n\n *Only author can skip and loop song*`)
                    .setFooter(`Played by: ${message.member.displayName} `, message.author.displayAvatarURL());

                    const embed3 = new MessageEmbed()
                    .setColor("GREEN")
                    .setTitle('<a:SahanMusic:903182448152678481> Song was Ended')
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setDescription(`**<a:SahanMusic:903182448152678481>** [${song.title}](${song.url}) \n\n **<a:SahanMusic:903182448152678481>Song Duration** ${np} minutes \n\n **Status:** **Finished** `)
                    .setFooter(`Played by: ${message.member.displayName} `, message.author.displayAvatarURL());
...
const { channel } = message.member.voice;
      ...
      const embed2 = new MessageEmbed()
                    ...
                    .setTimestamp()
                    .setImage("https://i.imgur.com/x0f7AZM.gif")
                    .setDescription(`**<a:SahanMusic:903182448152678481>** [${song.title}](${song.url}) \n\n **<a:SahanMusic:903182448152678481> Şarkı Süresi ** ${np} minutes \n\n **Status:** Skiped by ${b.clicker.member} `)
                    .setFooter(`Played by: ${message.member.displayName} `, message.author.displayAvatarURL());
