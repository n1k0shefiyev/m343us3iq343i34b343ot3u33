...
client.on("message", async message => {
  ...
  if (message.content.match(prefixMention)) {
    ...
    let embed = new MessageEmbed()
        ...
        :question: Still need help? [Click Here](https://discord.gg/Y6mYH4Zzm3) to join server
        `)
...
require('http').createServer((req, res) => res.end(`
 ...
 |• Author: Supreme#2401                   |
 |-----------------------------------------|
 |• Server: https://discord.gg/B78qabc9Vm  |
 |-----------------------------------------|
 |• Github: https://discord.gg/B78qabc9Vm  |
 |-----------------------------------------|
